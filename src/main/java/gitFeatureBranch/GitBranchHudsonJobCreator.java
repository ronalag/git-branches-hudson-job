...
public class GitBranchHudsonJobCreator extends Builder {
    ...
    public boolean perform(AbstractBuild build, Launcher launcher, BuildListener listener) {
        ...
        Shell s1 = new Shell("wget https://raw.github.com/ronalag/git-branches-hudson-job/master-delete-old-jobs/scripts/gen-hudson-job-git-branches --no-check-certificate");
